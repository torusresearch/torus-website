<template>
  <div class="font-weight-bold text_2--text">
    <span>
      ...
      <span v-if="activeButtonDetails.verifier === GOOGLE_VERIFIER">
      ...
      <span
        ...
        :class="[
          ...
          { 'font-weight-bold': !$vuetify.breakpoint.xsOnly },
        ]"
      >
...
<script>
import { GOOGLE_VERIFIER } from '../../../utils/enums'
