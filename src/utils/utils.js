...
export const paymentProviders = {
  ...
  [PAYBIS]: {
    ...
    status: ACTIVE,
    logoExtension: SVG,
    supportPage: 'mailto:support@paybis.com',
    minOrderValue: 10,
    maxOrderValue: 20_000,
    validCurrencies: supportedFiatCurrencies(PAYBIS),
    validCryptoCurrenciesByChain: {
      [MAINNET]: [
        { value: 'AAVE', display: 'AAVE' },
        ...
        { value: 'CRV', display: 'CRV' },
        { value: 'DAI', display: 'DAI' },
        { value: 'ETH', display: 'ETH' },
        { value: 'HOT', display: 'HOT' },
        { value: 'KNC', display: 'KNC' },
        { value: 'LINK', display: 'LINK' },
        { value: 'MKR', display: 'MKR' },
        { value: 'NMR', display: 'NMR' },
        { value: 'PERP', display: 'PERP' },
        { value: 'SAND', display: 'SAND' },
        { value: 'SHIB', display: 'SHIB' },
        { value: 'SUSHI', display: 'SUSHI' },
        { value: 'SXP', display: 'SXP' },
        { value: 'WBTC', display: 'WBTC' },
        { value: 'YFI', display: 'YFI' },
        { value: 'USDC', display: 'USDC' },
        { value: 'USDT', display: 'USDT' },
      ],
