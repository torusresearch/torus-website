...
import EncryptionPublicKeyManager from '../../../src/controllers/EncryptionPublicKeyManager'

describe('Encryption Public Key Manager', () => {
  let messageManager

  beforeEach(() => {
    messageManager = new EncryptionPublicKeyManager()
  })

  describe('#getUnapprovedMsgCount', () => {
    it('should be empty if no unapproved msgs', () => {
      const result = messageManager.unapprovedEncryptionPublicKeyMsgCount
