...
import { GOERLI, KOVAN, LOCALHOST, MAINNET, MATIC, MATIC_CODE, MATIC_URL, MUMBAI, MUMBAI_CODE, MUMBAI_URL, RINKEBY, ROPSTEN, RPC, SUPPORTED_NETWORK_TYPES } from '../utils/enums'
...
export default class NetworkController extends EventEmitter {
  ...
  async setProviderType(type, rpcTarget = '', ticker = 'ETH', nickname = '') {
    ...
    assert(INFURA_PROVIDER_TYPES.has(type) || type === LOCALHOST || type === MATIC || type === MUMBAI, `NetworkController - Unknown rpc type "${type}"`)
