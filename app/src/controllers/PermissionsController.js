...
export class PermissionsController {
  constructor({ platform, notifyDomain, notifyAllDomains, keyringController } = {}, restoredPermissions = {}, restoredState = {}) {
      ...
      this.permissions.removePermissionsFor(
        ...
        perms.map(methodName => {
          if (methodName === 'eth_accounts') {
            this.notifyDomain(origin, { method: ACCOUNTS_CHANGED_NOTIFICATION, result: [] })
          }
