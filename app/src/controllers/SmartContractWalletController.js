  ...
  */
  async signTransaction(txId, txStateManager, chainId) {
    try {
      ...
      const biconomyBaseURL = config.biconomyBaseURL.concat('/v2/meta-tx/native')

      log.info(biconomyBaseURL)
      ...
      const params = [fromSCW, methodData, nonce, signatures, 0, 0]
      ...
      let res = await post(biconomyBaseURL, biconomyReqObj, {
        headers: {
          'x-api-key': '87RpozCfF.dca41cbc-f61e-4848-aba5-96678bd1335b', //ropsten specific
