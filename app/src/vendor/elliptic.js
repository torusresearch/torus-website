(function (f) { if (typeof exports === 'object' && typeof module !== 'undefined') { module.exports = f() } else if (typeof define === 'function' && define.amd) { define([], f) } else { var g; if (typeof window !== 'undefined') { g = window } else if (typeof global !== 'undefined') { g = global } else if (typeof self !== 'undefined') { g = self } else { g = this }g.elliptic = f() } })(function () {
  ...
  }, { '../package.json': 30, './elliptic/curve': 4, './elliptic/curves': 7, './elliptic/ec': 8, './elliptic/eddsa': 11, './elliptic/utils': 15, 'brorand': 17 }],
