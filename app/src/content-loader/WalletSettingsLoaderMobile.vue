<template>
  <div class="sk-grid">
    ...
    <div class="sk-grid__col-mob-4">
      <div :class="$vuetify.theme.dark ? 'dark' : ''" class="sk-loader" style="height: 160px; margin-bottom: 15px"></div>
    </div>
    <div class="sk-grid__col-mob-4">
      <div :class="$vuetify.theme.dark ? 'dark' : ''" class="sk-loader" style="height: 160px; margin-bottom: 15px"></div>
    </div>
    <div class="sk-grid__col-mob-4">
      <div :class="$vuetify.theme.dark ? 'dark' : ''" class="sk-loader" style="height: 250px; margin-bottom: 15px"></div>
    </div>
    <div class="sk-grid__col-mob-4">
      <div :class="$vuetify.theme.dark ? 'dark' : ''" class="sk-loader" style="height: 160px; margin-bottom: 15px"></div>
    </div>
