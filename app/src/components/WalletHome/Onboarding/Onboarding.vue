      ...
      <v-carousel-item>
        <v-layout class="d-flex flex-column fill-height py-10 px-8">
          ...
          <v-flex class="flex-grow-1">
            <v-layout fill-height pt-6 pb-2 mx-n4>
              <v-flex xs6 px-4>
                <v-card class="elevation-1 fill-height px-3" :dark="$vuetify.theme.isDark" :light="!$vuetify.theme.isDark" @click="carouselCount = 1">
                  <div class="d-flex flex-column text-center fill-height justify-center">
                    <img :src="`../../../images/onboarding-1-1.svg`" :alt="t('walletHome.obSetupYes')" />
              ...
              <v-flex xs6 px-4>
                <v-card class="elevation-1 fill-height px-3" :dark="$vuetify.theme.isDark" :light="!$vuetify.theme.isDark" @click="carouselCount = 2">
                  <div class="d-flex flex-column text-center fill-height justify-center">
                    <img :src="`../../../images/onboarding-1-2.svg`" :alt="t('walletHome.obSetupNo')" />
                    <div class="text_2--text body-2 font-weight-bold mt-6">
      ...
      <v-carousel-item>
        <v-layout class="d-flex flex-column fill-height py-10 px-8">
          ...
          <v-flex class="flex-grow-0" mt-auto>
            <v-layout wrap mx-n1>
              <v-flex xs6 px-1>
                <img class="onboarding-image" :src="`../../../images/onboarding-2.svg`" alt="Onboarding Features" />
              </v-flex>
      ...
      <v-carousel-item>
        <v-layout class="d-flex flex-column fill-height py-10 px-8">
          ...
          <v-flex class="flex-grow-0" mt-auto>
            <v-layout mx-n1>
              <v-flex xs6 px-1>
                <img class="onboarding-image" :src="`../../../images/onboarding-2.svg`" alt="Onboarding Getting Started" />
              </v-flex>
              <v-flex xs6 px-1 class="align-self-end">
                <v-layout wrap mx-n1>
      ...
      <v-carousel-item>
        <v-layout class="d-flex flex-column fill-height py-10 px-8">
          ...
          <v-flex class="flex-grow-0" mt-auto>
            <v-layout mx-n1>
              <v-flex xs6 px-1>
                <img class="onboarding-image" :src="`../../../images/onboarding-3.svg`" alt="Onboaring Privacy and Security" />
              </v-flex>
              <v-flex xs6 px-1 class="align-self-end">
                <v-layout mx-n1>
                  <v-flex xs12 px-1 class="text-right">
