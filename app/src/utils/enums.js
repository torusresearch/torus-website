...
export const GOOGLE_VERIFIER = 'google'
export const FACEBOOK_VERIFIER = 'facebook'
export const REDDIT_VERIFIER = 'reddit'
export const DISCORD_VERIFIER = 'discord'
export const TWITCH_VERIFIER = 'twitch'
export const GITHUB_VERIFIER = 'torus-auth0-github'
export const LINKEDIN_VERIFIER = 'torus-auth0-linkedin'
export const TWITTER_VERIFIER = 'torus-auth0-twitter'
export const WEIBO_VERIFIER = 'torus-auth0-weibo'
export const LINE_VERIFIER = 'torus-auth0-line'
export const APPLE_VERIFIER = 'torus-auth0-apple'
