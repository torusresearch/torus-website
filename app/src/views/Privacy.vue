<template>
  <div>
    <p>
      Torus Labs Private Limited will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this
      Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place
    ...
    <p>Torus Labs Private Limited may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
    <ul>
      <li>To comply with a legal obligation</li>
      <li>To protect and defend the rights or property of Torus Labs Private Limited</li>
    ...
    <ul>
      <li>By visiting this page on our website: https://tor.us/privacy.html</li>
    </ul>
  </div>
</template>
