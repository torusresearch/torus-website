<template>
  <svg width="21px" height="14px" viewBox="0 0 21 14" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    <g id="Invision-2" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
      <g id="Desktop-Account-2" transform="translate(-26.000000, -139.000000)">
        <g id="Plus-circle-Copy-2" transform="translate(24.000000, 134.000000)">
          <rect id="Rectangle" fill="#000000" opacity="0" x="0" y="0" width="25" height="24" />
          <path
