  ...
  <svg width="29px" height="24px" viewBox="0 0 29 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    ...
    <g id="Invision-2" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round">
      <g
        ...
        stroke-width="2.8"
      >
        <g id="Group-2" transform="translate(150.000000, 261.000000)">
          <g id="Eye-off" transform="translate(615.000000, 92.000000)">
            <path d="M18.0555556,5.71428571 L23.6111111,0" id="Stroke-1" />
            <path d="M18.0555556,0 L23.6111111,5.71428571" id="Stroke-3" />
            <path
              :d="
