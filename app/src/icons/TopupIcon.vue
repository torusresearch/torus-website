<template>
  <svg width="18px" height="20px" viewBox="0 0 18 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    <g id="Invision-2" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
      <g id="Account-2-account" transform="translate(-27.000000, -531.000000)">
        <g id="Account-Menu" transform="translate(24.000000, 357.000000)">
          <g id="Group">
            <g id="Group-2" transform="translate(0.000000, 124.000000)">
              <g id="Info-circle-Copy" transform="translate(0.000000, 48.000000)">
                ...
                <path
                  ...
                  stroke-linejoin="round"
                />
                <path d="M20,6 L20,18" id="Stroke-7" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M4,6 L4,18" id="Stroke-9" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
              </g>
            </g>
          </g>
        </g>
