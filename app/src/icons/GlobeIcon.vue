<template>
  <svg width="40px" height="40px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
      <g transform="translate(-154.000000, -441.000000)">
        <g transform="translate(150.000000, 198.000000)">
          <g transform="translate(0.000000, 239.000000)">
            <rect fill="#000000" fill-rule="evenodd" opacity="0" x="0" y="0" width="48" height="48" />
            <path
            ...
            <path
              ...
              stroke-linejoin="round"
            />
            <path d="M42,23.9998 L6,23.9998" stroke="currentColor" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
          </g>
        </g>
      </g>
    </g>
