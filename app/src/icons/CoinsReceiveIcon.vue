<template>
  ...
  >
    <g>
      ...
      />
      <path fill="currentColor" d="M68.3,32.3h-0.2c-1,0-1.7,0.8-1.7,1.7s0.8,1.7,1.7,1.7h0.2c1,0,1.7-0.8,1.7-1.7S69.2,32.3,68.3,32.3z" />
      <path fill="currentColor" d="M60.3,32.3L60.3,32.3c-1.1,0-1.8,0.8-1.8,1.7s0.8,1.7,1.7,1.7h0.1c1,0,1.7-0.8,1.7-1.7S61.3,32.3,60.3,32.3z" />
    </g>
  </svg>
</template>
