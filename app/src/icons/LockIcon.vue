<template>
  <svg width="32px" height="36px" viewBox="0 0 32 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    <g id="Invision-2" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
      <g id="Settings-Expanded" transform="translate(-158.000000, -204.000000)">
        <g id="Group-5" transform="translate(150.000000, 198.000000)">
          <g id="Icons-/-Lock">
            ...
            <path
              ...
              stroke-linejoin="round"
            />
            <path d="M24,28 L24,32" id="Stroke-5" stroke="currentColor" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
          </g>
        </g>
      </g>
    </g>
