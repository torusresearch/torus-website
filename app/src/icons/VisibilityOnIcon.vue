<template>
  <svg width="30px" height="20px" viewBox="0 0 30 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    ...
    <g id="Invision-2" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
      <g id="Settings-&gt;-Privacy-and-Security-&gt;-Private-Key" transform="translate(-762.000000, -353.000000)">
        <g id="Group" transform="translate(150.000000, 261.000000)">
          <g id="Eye" transform="translate(610.000000, 85.000000)">
            ...
            <path
              :d="
                `M19.8333333,17 C19.8333333,18.564 18.564,19.8333333 17,19.8333333 C15.436,19.8333333 14.1666667,
