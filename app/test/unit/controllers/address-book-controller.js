...
//         assert.strictEqual(addressBookController._getAddressBook().length, 0)
//       })
//     })
...
//         assert.strictEqual(addressBook.length, 1, 'incorrect address book length.')
//         assert.strictEqual(addressBook[0].address, '0x01234', 'incorrect addresss')
//         assert.strictEqual(addressBook[0].name, 'test', 'incorrect nickname')
//       })
...
//         var addressBook = addressBookController._getAddressBook()
//         assert.strictEqual(addressBook.length, 0, 'incorrect address book length.')
//       })
//     })
//   })
// })
